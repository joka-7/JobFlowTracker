 ...
 * before a restorable session resolves (see useCloudSync's `authResolved`), or
 * while a write was failing, was destroyed the moment the pull landed.
 *
 * Writes are keyed per collection because a mode's records sync independently.
 */

const STORAGE_PREFIX = 'jft_pending_sync_v1';
